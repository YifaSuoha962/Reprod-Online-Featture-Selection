...
def onlineFSA_numexp(gen_data, eta, lbd, loop_time, adaptive = True):
    ###
    ## Parameters
    ###
    n = gen_data["n"]
    ...
    for i in range(loop_time):
        ...
        ## FSA Experiment
        FSA_experiment = onlineFSA.onlineFSA(XX_normalize, XY_normalize, FSA_para, 15, adaptive)
        ## end time
    ...
    return(result_mat)
###################################################################################
#### n = 500, 1000, 5000, 10000, 50000, 100000, p = 1000, k = 100, alpha = 1, beta = 1, 0.1, 0.01 
###################################################################################
#######################
### beta = 1
#######################
